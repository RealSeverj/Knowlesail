...
<template>
  <div class="relative flex items-start gap-3 rounded-xl/70 px-3 py-2 text-xs">
    <button
    ...
    <!-- 操作菜单：使用通用 PopMenu 组件 -->
    <PopMenu v-model="showActions">
      <button
    ...
    <PopMenu v-model="showQuadrantSelector" width-class="w-48">
